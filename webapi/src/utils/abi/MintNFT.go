...
// TokenIdCounter is a free data retrieval call binding the contract method 0x84c4bd4b.
//
// Solidity: function _tokenIdCounter() view returns(uint256)
func (_MintNFT *MintNFTCaller) TokenIdCounter(opts *bind.CallOpts) (*big.Int, error) {
	var out []interface{}
	err := _MintNFT.contract.Call(opts, &out, "_tokenIdCounter")
...
//
// Solidity: function _tokenIdCounter() view returns(uint256)
func (_MintNFT *MintNFTSession) TokenIdCounter() (*big.Int, error) {
	return _MintNFT.Contract.TokenIdCounter(&_MintNFT.CallOpts)
}

// TokenIdCounter is a free data retrieval call binding the contract method 0x84c4bd4b.
//
// Solidity: function _tokenIdCounter() view returns(uint256)
func (_MintNFT *MintNFTCallerSession) TokenIdCounter() (*big.Int, error) {
	return _MintNFT.Contract.TokenIdCounter(&_MintNFT.CallOpts)
}
